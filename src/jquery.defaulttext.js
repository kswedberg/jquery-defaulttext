(function($){
  ...
  $.fn.defaulttext = function(options) {
    ...
    $inputs.each(function() {
      ...
      $input.on('focus.dt', focusText);
      $input.on('blur.dt', blurText);
      $input.prev()
      ...
      if ( opts.showOnHover ) {
        $input.parent().on('mouseenter.dt mouseleave.dt', function(event) {
    ...
    if (activeInputs.length) {
      ...
      $(document)
      .on('focusText.dt', focusText)
      .on('blurText.dt', blurText);
